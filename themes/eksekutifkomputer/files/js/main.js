(function($) {
    ...
    /*-------------------------------------
     ...
     --------------------------------------*/
    $('nav#dropdown').meanmenu({ siteLogo: "<a href='index.php?r=site/index' class='logo-mobile-menu'><img src='/eksekutifcommerce/themes/eksekutifkomputer/files/img/logoec.png' width='15%' /></a>" });
